...
function Camera() {
  ...
  const [webcamImage, setWebcamImage] = useState(false);
  ...
  useEffect(() => {
    if (webcamImage) {
      setTimeout(() => setIsAuraReady(true), 4000);
    }
  }, [webcamImage]);
    ...
    <>
      <div id="print-preview">
        ...
        >
          ...
          {isCapturingPhoto && webcamImage && facePosition ? (
            <div
